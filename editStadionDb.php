...
if ($uploadOk == 0) {
  ...
  if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
    try
	{
		...
		$sql="UPDATE stadion SET Nume='".$_POST['nume']."', Adresa='".$_POST['adresa']."', Capacitate='".$_POST['capacitate']."', Echipa='".$_POST['echipa']."', Poza='".$target_file."' WHERE Id=".$_POST["Id"];
		$conn->query($sql);
...
else
{
  try
  {
    $conn=new mysqli($host,$user,$pas,$dbname);
    echo "Conexiunea este reușită<br>";
    $sql="UPDATE stadion SET Nume='".$_POST['nume']."', Adresa='".$_POST['adresa']."', Capacitate='".$_POST['capacitate']."', Echipa='".$_POST['echipa']."'";
