...
if ($uploadOk == 0) {
  ...
  if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
    try
	{
		...
		$sql="UPDATE liga SET Nume='".$_POST['nume']."', Tara='".$_POST['tara']."', Nr_Echipe='".$_POST['echipe']."', Lider='".$_POST['lider']."', Logo='".$target_file."' WHERE Id=".$_POST["Id"];
		$conn->query($sql);
...
else
{
  try
  {
    $conn=new mysqli($host,$user,$pas,$dbname);
    echo "Conexiunea este reușită<br>";
    $sql="UPDATE liga SET Nume='".$_POST['nume']."', Tara='".$_POST['tara']."', Nr_Echipe='".$_POST['echipe']."', Lider='".$_POST['lider']."'";
