...
if ($uploadOk == 0) {
  ...
  if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
    try
	{
		...
		$sql="UPDATE antrenori SET Nume='".$_POST['nume']."', Prenume='".$_POST['prenume']."', Club='".$_POST['club']."', Certificare='".$_POST['certificare']."', Varsta='".$_POST['varsta']."', Poza='".$target_file."' WHERE Id=".$_POST["Id"];
		$conn->query($sql);
...
else
{
  try
  {
    $conn=new mysqli($host,$user,$pas,$dbname);
    echo "Conexiunea este reușită<br>";
    $sql="UPDATE antrenori SET Nume='".$_POST['nume']."', Prenume='".$_POST['prenume']."', Club='".$_POST['club']."', Certificare='".$_POST['certificare']."', Varsta='".$_POST['varsta']."'";
