...
<body>
	<?php
		...
		$sql="SELECT * FROM club WHERE Id = ".$_POST['Id'];
		$result=$conn->query($sql);
		$r=$result->fetch_array(MYSQLI_NUM);
	?>
	<form method="post" action="editClubDb.php" enctype="multipart/form-data">
		...
		<table>
			...
			<tr>
				<td>Jucatori</td>
				<td><input type="text" name="jucatori" value=<?php echo $r[2]; ?>></td>
			</tr>
			<tr>
				<td>Antrenor</td>
				<td><input type="text" name="antrenor" value=<?php echo $r[3]; ?>></td>
			</tr>
			<tr>
				<td>Pret</td>
				<td><input type="text" name="pret" value=<?php echo $r[4]; ?>></td>
			</tr>
			<tr>
				<td>
